...
//---------------------------------------------------------------------------
bool __fastcall FuncCryptXE::DecryptString(AnsiString InStr, AnsiString &OutStr, AnsiString Key)
{
...
//---------------------------------------------------------------------------
bool __fastcall FuncCryptXE::DecryptFromFile(String FileName, AnsiString &OutStr, AnsiString Key)
{
  HANDLE FileHandle;
  DWORD Size, R;
